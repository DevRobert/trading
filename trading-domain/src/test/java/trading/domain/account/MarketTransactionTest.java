...
public class MarketTransactionTest {
    ...
    public void initializationFails_ifIsinNotSpecified() {
        try {
            new MarketTransaction(MarketTransactionType.Buy, null, new Quantity(10), new Amount(1000.0), new Amount(20.0), LocalDate.now());
        }
        catch(DomainException ex) {
    ...
    public void initializationFails_ifQuantityNotSpecified() {
        try {
            new MarketTransaction(MarketTransactionType.Buy, ISIN.MunichRe, null, new Amount(1000.0), new Amount(20.0), LocalDate.now());
        }
        catch(DomainException ex) {
    ...
    public void initializationFails_ifQuantityNegative() {
        ...
        try {
            new MarketTransaction(MarketTransactionType.Buy, ISIN.MunichRe, new Quantity(-1), totalPrice, commission, LocalDate.now());
        }
        catch(DomainException ex) {
    ...
    public void initializationFails_ifQuantityZero() {
        ...
        try {
            new MarketTransaction(MarketTransactionType.Buy, ISIN.MunichRe, new Quantity(0), totalPrice, commission, LocalDate.now());
        }
        catch(DomainException ex) {
    ...
    public void initializationFails_ifTotalPriceNotSpecified() {
        try {
            new MarketTransaction(MarketTransactionType.Buy, ISIN.MunichRe, new Quantity(1), null, new Amount(20.0), LocalDate.now());
        }
    ...
    public void initialzationFails_ifCommissionNotSpecified() {
        try {
            new MarketTransaction(MarketTransactionType.Buy, ISIN.MunichRe, new Quantity(1), new Amount(1000.0), null, LocalDate.now());
        }
        catch(DomainException e) {
    ...
    public void initializationFails_ifDateNotSpecified() {
        try {
            new MarketTransaction(MarketTransactionType.Buy, ISIN.MunichRe, new Quantity(1), new Amount(1000.0), new Amount(10.0), null);
        }
        catch(DomainException e) {
    ...
    public void toString_ifBuy() {
        ...
        MarketTransaction transaction = new MarketTransaction(MarketTransactionType.Buy, isin, new Quantity(10), totalPrice, commission, LocalDate.now());
    ...
    public void toString_ifSell() {
        ...
        MarketTransaction transaction = new MarketTransaction(MarketTransactionType.Sell, isin, new Quantity(10), totalPrice, commission, LocalDate.now());
